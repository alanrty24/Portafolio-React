const Myprojects = () => {
  return (
    <section className="bg-linear-to-b from-85% from-(--color-font-p2) to-(--color-font-p1) flex flex-col gap-4 pb-8">
      <h3 className="text-center text-4xl text-white text-shadow-md text-shadow-black font-bold md:text-6xl ">My Projects</h3>
