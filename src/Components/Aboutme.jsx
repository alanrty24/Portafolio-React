  ...
  return (
    <section className="min-h-auto bg-linear-to-b from-85% from-(--color-font-p2) to-(--color-font-p1) py-4 lg:flex-row" id="aboutMe">
      <div className="flex flex-col gap-2 py-4 lg:w-1/2">
        <h3 className="text-center pb-2 text-xl text-(--color-tertiary)  font-bold">
          ABOUT <span className="text-(--color-secundary) ">ME</span>
        </h3>
        <p className="py-2 text-base/8 indent-4 font-light text-star text-black md:text-xl/7">
        ...
        <p className="py-2 text-base/8 indent-4 font-light text-center text-black md:text-xl/7">
